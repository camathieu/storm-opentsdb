...
import storm.opentsdb.example.bolt.OpenTsdbEventGeneratorBolt;
...
public class OpenTsdbBoltEventExampleTopology {
    ...
    public static StormTopology buildTopology() {
        ...
        builder
            .setBolt("events", new OpenTsdbEventGeneratorBolt("OpenTsdbBoltTupleExampleTopology", new HashMap<String, String>()), 1)
